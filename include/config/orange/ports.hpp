...
inline constexpr std::int8_t INTAKE_STAGE_1 = 4;  // TODO: Set port for first stage intake motor
...
// Pneumatics
inline constexpr std::int8_t PISTON_MATCHLOADER = 2;  // TODO: Set ADI port for matchloader piston
inline constexpr std::int8_t PISTON_INDEXER = 1;      // TODO: Set ADI port for indexer piston
